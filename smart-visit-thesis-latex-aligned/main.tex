...
\usepackage{pdflscape}
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, fit, backgrounds, shapes.geometric, calc, decorations.pathreplacing}
...
\newcommand{\ThesisSupervisor}{Supervisor: IMADEDDINE MOUNTASSER}
...
\include{chapters/02-problem}
\include{chapters/03-state-of-art}
\include{chapters/04-solution}
