...
\end{axis}
\end{tikzpicture}
\caption[Protocol-faithfulness vs.\ Chen 2016]{Protocol-faithfulness check: our
assumption-free baselines reproduce Chen 2016 on the $y=x$ line (one marker per Flickr city;
cf.\ Table~\ref{tab:flickr-faith}).}
