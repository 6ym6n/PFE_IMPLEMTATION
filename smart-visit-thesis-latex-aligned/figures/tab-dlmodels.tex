...
\par\vspace{3pt}
{\footnotesize\itshape Columns:\/ \upshape ST = spatio-temporal features; UI = user/identity
modelling; Ctx = explicit context (weather/time-of-day); QT = queuing-time modelling;
MT = multi-task output.\par}
\end{table}