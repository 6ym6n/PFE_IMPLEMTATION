...
For a traveller, a city visit is a small planning project: a limited number of days, a long list of candidate places, and the wish to spend the available time well. Multiplied across the globe, these individual trips add up to one of the world's largest economic activities---the World Travel and Tourism Council estimates that travel and tourism contributed roughly USD~9.9 trillion in 2023, around 9.1\% of world GDP, while supporting more than 320~million jobs~\cite{wttc2024}. The sector's importance is not only economic: it drives cultural exchange, urban development, and regional growth, and nations at every income level rely on visitor flows to sustain their local communities~\cite{unwto2024}.
...
\input{figures/fig-intro-overview}
